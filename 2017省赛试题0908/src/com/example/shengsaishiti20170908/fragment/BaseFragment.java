...
public class BaseFragment extends Fragment {
	...
	private ToggleButton tg_lamp1, tg_lamp2, tg_warm, tg_fan, tg_door, tg_tv,
			tg_kt, tg_dvd, tg_cur;
	private TextView tv_temp, tv_hum, tv_ill, tv_smo, tv_press, tv_gas, tv_pm,
			tv_co, tv_per;
	public static float temp, hum, ill, smo, press, gas, pm, co, per;
	private LinearLayout line_door, line_tv, line_kt, line_dvd;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		initView(view);
		if (AppConfig.user.equals("user")) {
			line_door.setVisibility(View.GONE);
			line_dvd.setVisibility(View.GONE);
	...
	private void initView(View view) {
		...
		line_door = (LinearLayout) view.findViewById(R.id.line_door);
		line_dvd = (LinearLayout) view.findViewById(R.id.line_dvd);
		line_kt = (LinearLayout) view.findViewById(R.id.line_kt);
		line_tv = (LinearLayout) view.findViewById(R.id.line_tv);
	}
