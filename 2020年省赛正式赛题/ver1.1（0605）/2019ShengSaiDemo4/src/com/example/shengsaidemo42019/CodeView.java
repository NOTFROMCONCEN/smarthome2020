 ...
 * @year 2019
 * @Todo TODO 绘制随机验证码
 * @package_name com.exampleguosaidemo32019.code
 * @project_name 2019GuoSaiDemo3
 * @file_name CodeView.java
 */
public class CodeView {
	private static int HEIGHT = 40;// 位图高
	...
	// 方法：createRandomText 描述：生成一组随机数（大小根据设定“xCode_Random_NUMBER”）
