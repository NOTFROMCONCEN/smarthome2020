...
public class LinkFragment extends Fragment {
	...
	public static TextView tv_link_counttime, tv_link_time;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		sw_wamr.setOnCheckedChangeListener(new OnCheckedChangeListener() {
					...
					if (et_link_data.getText().toString().isEmpty()
						...
						if (btn_link_state.getText().toString().equals("开启联动")) {
							...
							final String spinner_2 = sp_2.getSelectedItem()
									.toString();
							final int number_get = Integer.valueOf(et_link_data
									.getText().toString());
							...
							if (link_state) {
								num = Integer.valueOf(et_link_time.getText()
										.toString()) * 1000 * 60;
								timer = new CountDownTimer(num, 1000) {
									...
									public void onTick(long millisUntilFinished) {
										...
										tv_link_counttime.setText("联动模式还有"
												+ min + "分" + sec + "秒");
									}
	...
	private void initView(View view) {
		...
		sw_wamr = (Switch) view.findViewById(R.id.sw_warm);
